...
- **Two documented MCP tools** (`get_fractional_working_index`, `get_fwi_weekly_brief`) as a reference implementation; a hosted MCP server is on the roadmap, and agents call the live REST API directly today
