...
import { Settings, User, LogIn, UserPlus, Database, Bell, Download, LogOut, KeyRound } from 'lucide-react';
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    ...
                    className="flex min-h-11 min-w-11 items-center gap-1.5 rounded-full px-2.5 text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground lg:min-h-8 lg:min-w-0"
                  >
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    ...
                    className="relative flex h-11 w-11 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground lg:h-8 lg:w-8"
                  >
                    <Bell size={16} />
                    {alerts.length > 0 && (
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    aria-label={user ? `Account menu for ${user.email ?? 'signed-in user'}` : 'Account menu'}
                    className="h-11 w-11 text-muted-foreground hover:text-foreground lg:h-8 lg:w-8"
                  >
                    <User size={16} />
                  </Button>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  {user ? (
                    ...
                    <div className="px-2 py-1.5 text-xs text-muted-foreground">Checking account…</div>
                  ) : (
                    <>
